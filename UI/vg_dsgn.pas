...
uses
  ...
  vg_scene, vg_utils, vg_layouts, vg_objects, vg_controls, vg_colors, vg_ani,
...
function TvgBrushDesign.UniqueName(Component: TComponent): string;
begin
...
begin
  ...
  FBrush.SolidColor := (FBrush.SolidColor and not $FFFFFF) or ($00FFFFFF and HSLtoRGB(solidQuad.Hue, solidQuad.Sat, solidQuad.Lum));
...
begin
  ...
  gradEditor.Gradient.Points[gradEditor.CurrentPoint].IntColor :=
    (gradEditor.Gradient.Points[gradEditor.CurrentPoint].IntColor and $FF000000) or ($00FFFFFF and HSLtoRGB(gradQuad.Hue, gradQuad.Sat, gradQuad.Lum));
  FBrush.Gradient.Assign(gradEditor.Gradient);
